 ...
 * a transition word.
 * @param {function} t The Drupal.t function.
 * @returns {object} Object containing score and text.
 */
const calculateTransitionWordResult = function( transitionWordSentences, t ) {
  ...
  if ( score < 7 && percentage === 0 ) {
    return {
      ...
      hasMarks: hasMarks,
      text: t("Transition words: None of the sentences contain transition words. Use some."),
    };
  }
  ...
  if ( score < 7 ) {
    return {
      score: formatNumber( score ),
      hasMarks: hasMarks,
      text: t("Transition words: Only @percentage of the sentences contain transition words, which is not enough. Use more of them.", {
  ...
  return {
    score: formatNumber( score ),
    hasMarks: hasMarks,
    text: t("Transition words: Well done!"),
  };
};
 ...
 */
const transitionWordsAssessment = function( paper, researcher, t ) {
...
export default {
  ...assessments.TransitionWordsAssessment,
