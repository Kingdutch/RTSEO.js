...
import {inRangeEndInclusive as inRange} from "yoastseo/src/helpers";

export default class SubheadingDistributionTooLong extends assessments.readability.SubheadingDistributionTooLongAssessment {
  /**
